...
function questionClick() {
    ...
    if (this === questionStyle1) {
       ...
       */
        ...
        //创建一个span元素来存放题目序号
        const numSpan = document.createElement('label')
        numSpan.textContent = questionNum + '. (多选题)'
        ...
        questionName.style.type = 'text'
        questionName.classList.add('choice-name-box')
        numSpan.appendChild(questionName)
        checkbox.appendChild(numSpan)
...
saveButton.addEventListener('click', function () {
    ...
    */
    ...
    const boxTitleText = document.querySelector('.new-title').value
